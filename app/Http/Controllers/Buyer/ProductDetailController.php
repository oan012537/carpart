...
class ProductDetailController extends Controller
{
    public function index($name, $id)
    {
        ...
        $data['review_score_all'] = $review_score_all->orderby('created_at', 'desc')->get();
        ...
        $data['review_score_1'] = $review_score_1->orderby('created_at', 'desc')->get();
        ...
        $data['review_score_2'] = $review_score_2->orderby('created_at', 'desc')->get();
        ...
        $data['review_score_3'] = $review_score_3->orderby('created_at', 'desc')->get();
        ...
        $data['review_score_4'] = $review_score_4->orderby('created_at', 'desc')->get();
        ...
        $data['review_score_5'] = $review_score_5->orderby('created_at', 'desc')->get();
