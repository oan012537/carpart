...
class TableSupplierPermission extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('supplier_permission')) {
        ...
        Schema::create('supplier_permission', function (Blueprint $table) {
            ...
            $table->foreign('permission_role')->references('role_id')->on('supplier_role')->onDelete('cascade');
        });
    }
