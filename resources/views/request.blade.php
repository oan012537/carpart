                            ...
                            <div class="row">
                                <div class="col-8">
                                    <div class="box__model">
                                        <img src="assets/img/icon/smile.svg" class="img-fluid" alt="">
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <div class="box__image">
                                        <img src="assets/img/createrequest/imagenull-2.png" class="img-fluid" alt="">
                                    </div>
                                </div>
                                <div class="col-8">
                                    <div class="box__content">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div class="box__check">
                        <span class="txt__blue"> <img src="assets/img/icon/smile.svg" class="img-fluid" alt="">ตรงรุ่น</span> ผู้ขายยืนยันว่าสามารถใช้ร่วมกันได้
