                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="ระบุ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label> อีเมล </label>
                                                <input type="email" class="form-control" name="email" placeholder="ระบุ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" placeholder="ระบุ">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <textarea name="googlemap" class="form-control" placeholder="ระบุ"></textarea>
                                            </div>
                                        </div>
                                    </div>
