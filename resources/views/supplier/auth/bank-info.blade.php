                    ...
                    <div class="box-b-detail pdlogin-sup">
                        <form id="frm-register" action="{{route('supplier.register.store')}}" method="post">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="123-123456-1" aria-label="Username" name="bank_account_no" value="{{ old('bank_account_no') }}" aria-describedby="basic-addon1" required>
                            </div>
                            <div class="tt-text-log">
                                <p>{{ trans('file.Bank Account Name') }} <span class="dot__color"> *</span></p>
                            </div>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="{{ trans('file.Specify') }}" name="bank_account_name" value="{{ old('bank_account_name') }}" aria-label="Username" aria-describedby="basic-addon1" required>
                            </div>
                            <div class="tt-text-log">
                            ...
                            <div class='but-bb-log2'>
                                <button type="submit" class="button button1" id="submit-btn"> {{ trans('file.Next') }} &nbsp; <i class='fas fa-angle-right'></i>
                                </button>
