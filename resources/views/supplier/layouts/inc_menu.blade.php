...
<div class="l-navbar showmenu" id="nav-bar">
    <div class="box__wrappermenu">
        <div class="togglemobile">
            <div class="header_toggle"> <img src="{{asset('assets/img/navbar/icon-richmenu.svg')}}" alt="" id="header-toggle2"> </div>
        </div>

        <div class="icon__mobile"> <a href="supplier-notiboard.php" class="nav_logo"> <img src="{{asset('assets/img/navbar/logo-whites.svg')}}" class="img-fluid" alt=""> </a></div>

        <div class="nav-item dropdown langmobile">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                <img src="{{asset('assets/img/icon/icon-web.svg')}}" class="img-fluid" style="width: 30px" alt=""> {{ trans('file.Language') }}
            </a>
            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="{{ url('language_switch/th') }}">ไทย</a></li>
                <li>
