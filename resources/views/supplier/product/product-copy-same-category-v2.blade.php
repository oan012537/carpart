        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                ...
                <form id="msform" action="{{route('products.store')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @for ($o = 1; $o <= 2; $o++) <div class="accordion" id="acctab{{ $o }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="product_code{{ $o }}">{{ trans('file.ID') }}</label>
                                                                <input type="text" id="product_code{{ $o }}" class="form-control" name="product_code[]" placeholder="Auto Generate" value="{{ old('product_code') }}" readonly>
                                                            </div>
                                                        </div>

                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                <label for="name_th{{ $o }}">{{ trans('file.Product Name') }} (TH) <span>*</span></label>
                                                                <input type="text" id="name_th{{ $o }}" class="form-control" name="name_th[]" placeholder="{{ trans('file.Specify') }}" value="{{ old('name_th')? old('name_th'): $data->name_th }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="number" id="qty" class="form-control" name="qty" placeholder="{{ trans('file.Specify') }}" value="{{ old('qty')? old('qty'): $data->qty }}">
                                                            </div>
                                                        </div>
                                                        @endif
                                                                                    ...
                                                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                                                                        <div class="itemstype">
                                                                                            ...
                                                                                            <div class="form-check form-switch">
                                                                                                <input class="form-check-input" type="checkbox" role="switch" id="flexSwitchCheckDefault" name="transport_type_id[]" value="{{ $transport_type['id'] }}" @if (in_array($transport_type['id'], $transport_type_ids)) checked @endif>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    @endforeach
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-10 col-lg-10 col-md-10 col-12">
                                                        <div class="wrapper__checkbox">
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input" id="ready-to-ship" name="is_deliver" value="1" @if((isset($transport->is_deliver)? $transport->is_deliver:true) == true) checked @endif>
                                                            ...
                                                            <div class="form-check">
                                                                <input type="radio" class="form-check-input" id="longer-than-usual" name="is_deliver" value="0" @if((isset($transport->is_deliver)? $transport->is_deliver:true) == false) checked @endif>
                                                                <label class="form-check-label">
