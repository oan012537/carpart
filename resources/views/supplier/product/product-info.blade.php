                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="name_th" class="form-control" name="name_th" placeholder="{{ trans('file.Specify') }}" value="{{ old('name_th')? old('name_th'): $product_name_th }}">
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" id="name_en" class="form-control" name="name_en" placeholder="{{ trans('file.Specify') }}" value="{{ old('name_en')? old('name_en'): $product_name_en }}">
                                        ...
                                        <div class="col-xl-4 col-lg-6 col-md-6 col-12">
                                            <div class="box__itemsprice">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="product-price" class="form-control" name="price" placeholder="{{ trans('file.Specify') }}" value="{{ old('price') }}" required>
        ...
        <div class="box__datecreate">
            <form>
                ...
                <div class="form-group">
                    ...
                    {{-- <div class="box__status status-sold">{{ trans('file.Sold') }}
                </div>
