...
<body>
    <form method="POST" action="{{route('registercon-sup2')}}">
        @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="box-b-detail">
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="0123456789" aria-label="Username" name="phone"
                            ...
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Sample Name" aria-label="Username" name="facebook"
                                    aria-describedby="basic-addon1">
                            </div>
                            <div class="tt-text-log">
                                <p>
