...
@section('content')
<input type="hidden" id="pageName" name="pageName" value="review-order-detail">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-md-9">
                    ...
                    <div class="box__accordian__edit mb-3">
                        <div class="box__filter p-4">
                            <h5 class="mb-4"><i class="fas fa-comment-dots"></i> คะแนนสินค้า</h5>
                            <p>ความคุ้มค่าของสินค้าดีมาก บริการดีมาก ขนส่งดีมาก จัดส่งรวดเร็วมาก</p>
                            <div class="score">
