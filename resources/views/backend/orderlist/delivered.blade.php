...
@section('content')
<input type="hidden" id="pageName" name="pageName" value="delivered-order-detail">
                    ...
                    <div class="box__accordian__edit mb-3">
                        <div class="box__filter p-4">
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div>
                                    <h5>ที่ต้องจัดส่ง</h5>
                                    <span>ผู้ซื้อกำลังรอให้คุณทำการจัดส่งสินค้า</span>
                                </div>
                                <div>
                                    <button class="btn btn__app btn__noapproval text-white mt-3 mt-md-0">ปฏิเสธจัดส่งสินค้า</button>
                                </div>
                            </div>
