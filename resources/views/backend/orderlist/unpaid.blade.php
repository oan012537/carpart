...
@section('content')
<input type="hidden" id="pageName" name="pageName" value="unpaid-order-detail">
                    ...
                    <div class="box__accordian__edit mb-3">
                        <div class="box__filter p-4">
                            <div class="d-md-flex justify-content-between align-items-end">
                                <div>
                                    <h5>ยังไม่ได้ชำระ</h5>
                                    <span>อยู่ระหว่างรอให้ผู้ซื้อชำระเงินเพื่อทำการจัดส่ง</span>
                                </div>
                                <div>
                                    <button class="btn btn__app btn__noapproval text-white mt-3 mt-md-0">ปฏิเสธออเดอร์</button>
                                </div>
                            </div>
