...
@section('content')
<input type="hidden" id="pageName" name="pageName" value="shipping-order-detail">
                    ...
                    <div class="box__accordian__edit mb-3">
                        <div class="box__filter p-4">
                            <div class="d-flex justify-content-between align-items-end">
                                <div>
                                    <h5>กำลังจัดส่งสินค้า</h5>
                                    <span>Kerry - TH123456789</span>
                                </div>
                                    ...
                                    <li class="active">
                                        <span>
                                            ...
                                            <div>
                                                ...
                                                <div class="step-text">
                                                    <p class="mb-0">13.30 น. 07/11/64</p>
                                                    <small>Kerry - TH12345678 <i class="far fa-copy"></i> คัดลอก</small>
                                                </div>
                                            </div>
                                        </span>
