                                    ...
                                    {{-- <form class="form-box-input px-2"> --}}
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" id="type" name="type"
                                                    placeholder="eg. EMS, ส่งด่วน, ส่งภายในวัน, แมสเซนเจอร์%" required>
                                            </div>
                                            <div class="col-6">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control number" id="timeinbkk" name="timeinbkk"
                                                    placeholder="ระยะเวลาการจัดส่งในกทม" required>
                                            </div>
                                            <div class="col-6">
