                                    ...
                                    <form class="form-box-input px-2">
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-6">
                                                ...
                                                <input type="text" class="form-control" id="type" name="type"
                                                    placeholder="eg. EMS, ส่งด่วน, ส่งภายในวัน, แมสเซนเจอร์%" required value="{{$delivery->type}}">
                                            </div>
                                            <div class="col-6">
                                            ...
                                            <div class="col-3">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control border-end-0 w-50 number"
                                                        placeholder="00.00" name="weight" id="weight"  value="{{$delivery->weight}}">
                                            ...
                                            <div class="col-6">
                                                <div class="d-flex">
                                                    <input type="text" class="form-control text-center" id="wide"
                                                        placeholder="กว้าง" name="wide" value="{{$delivery->wide}}">
                                                    <span class="mx-2"></span>
                                                    <input type="text" class="form-control text-center" id="long"
                                                        placeholder="ยาว" name="long" value="{{$delivery->long}}">
                                                    <span class="mx-2"></span>
                                                    <input type="text" class="form-control text-center" id="high"
                                                        placeholder="สูง" name="high" value="{{$delivery->high}}">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="row ms-2">
                                                    <div class="col-3 form-check mt-2">
                                                        <input type="radio" class="form-check-input" id="warranty1"
                                                            name="warranty" value="1" required @if($delivery->warranty == '1') checked @endif>
                                                        <label class="form-check-label" for="warranty1">มี </label><br>
                                                    </div>
                                                    <div class="col-3 form-check mt-2">
                                                        <input type="radio" class="form-check-input" id="warranty2"
                                                            name="warranty" value="0" required @if($delivery->warranty == '0') checked @endif>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="row ms-2">
                                                    <div class="col-3 form-check mt-2">
                                                        <input type="radio" class="form-check-input" id="trackingnumber1"
                                                            name="trackingnumber" value="1" required @if($delivery->trackingnumber == '1') checked @endif>
                                                        <label class="form-check-label" for="trackingnumber1">มี </label><br>
                                                    </div>
                                                    <div class="col-3 form-check mt-2">
                                                        <input type="radio" class="form-check-input" id="trackingnumber2"
                                                            name="trackingnumber" value="0" required @if($delivery->trackingnumber == '0') checked @endif>
