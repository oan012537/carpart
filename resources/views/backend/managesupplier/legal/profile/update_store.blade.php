                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9">
                            <div class="box_editbox">
                                <div class="row">
                                    <div class="col-6">
                                        <label class="title__txt"> ชื่อบริษัท <span> * </span></label>
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <input type="text" class="form-control" id="" placeholder="www.page.com">
                                    </div>
                                </div>
                                <br>

                                <label class="title__txt"> หนังสือรับรองบริษัท อายุไม่เกิน 6 เดือน <span>
                                ...
                                <label class="title__txt"> สำเนา ภ.พ.20 <span> (รองรับไฟล์ .pdf, .jpg และ .png
                                        เท่านั้น. ขนาดไม่เกิน 5Mb.)) </span> </label>
                                <div class="card-img-up">
                                    <div class="img-product">
                                        <button class="btn-add-img">
