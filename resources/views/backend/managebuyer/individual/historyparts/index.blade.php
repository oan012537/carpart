                        ...
                        <div class="col-md-9">
                            <div class="box__table p-4">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#sold"> เปิดรับข้อเสนอ
                                            <span class="circle2"> 2</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#suspended"> ปิดรับคำขอ
                                            <span class="circle2"> 2</span>
                                        </a>
                                    </li>
                                </ul>
                                                ...
                                                <div class="col-6">
                                                    <div class="txt__kotxt">
                                                        <p> <i class="fa-solid fa-circle-exclamation"></i>
                                                            มีข้อเสนอใหม่ที่ยังไม่ได้ตรวจสอบ 2 รายการ</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="box_bb_box2">
                                                        <button class="btn btn__viewall">ดูข้อเสนอทั้งหมด
                                                            (20)</button>
                                                        <button class="btn btn__closerequst">สร้างใบคำขออีกครั้ง</button>
                                                    </div>
