                        ...
                        <div class="col-md-9">
                            <div class="box__table p-4">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#sold"> รับเคลม
                                            <span class="circle2"> 2</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#suspended"> ปฏิเสธการเคลม
                                            <span class="circle2"> 2</span>
                                        </a>
                                    </li>
                                </ul>
                                    ...
                                    <div id="all" class="tab-pane active"><br>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <div class="box__status status-close2">
                                                        <p>สถานะ : ปฏิเสธการเคลม</p>
                                                    </div>
                                                    <div class="txt_txt_bai5">
                                                        <p>
                                                            วันที่ได้รับสินค้า 15/12/2564
                                                        </p>
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="box_bb_box2">
                                                        <button class="btn btn__viewall">ดูข้อมูลการเคลม
                                                        </button>
                                                    </div>
                                        ...
                                        <div class="box_cardbox1">
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="box__status status-roro">
                                                        <p>สถานะ : รอตรวจสอบ</p>
                                                    </div>
                                                    <div class="txt_txt_bai5">
                                                        <p>
