        ...
        <div class="container">
            ...
            <div class="but-but-button6">
                ...
                <a href="{{ url($link_url, $link_id) }}">
                    <button class="button button6"> <i class='fas fa-angle-left'></i> กลับไปหน้าสินค้า </button>
                </a>
            </div>
            <br>
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="img-lo-iconniti">
                        <img src="assets/img/confirm/lo1.png" class="img-fluid" alt="shoe image">
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <p class="card-title"> {{ $product->name_th }}
                            </p>
            ...
            <div class="card3">
                <div class="card-body">
                    <p class="card-title"> ไม่มั่นใจว่าสามารถใช้ร่วมกันกับรถหรือ? คุณสามารถร้องขอการตรวจสอบจากผู้ขายได้
                    </p>
                        ...
                        <div class="div1">
                            <div class="drop-zone">
                                <span class="drop-zone__prompt">
                                    <p> อัพโหลดรูปภาพ</p>
                                    <button class="button button1"> อัพโหลด </button>
                                </span>
            ...
            <div class="card5">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <a herf="#">
                            <button class="button button2"> เลือกใช้บริการ </button>
                        </a>
                    </div>
                </div>
                <br>
                <div class="row">
                    ...
                    <div class="col-lg-2">
                        <a herf="#">
                            <button class="button button4"> เลือกใช้บริการ </button>
                        </a>
                    </div>
                </div>
                <br>
                        ...
                        <div style="text-align:center;">
                            <div class="b-but-concon">
                                <button class="button button1"
                                    ...
                                    class="w3-button w3-display-topright"> เข้าใจแล้ว </button>
                            </div>
                        </div>
                    </div>
                </div>
