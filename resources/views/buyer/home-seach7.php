...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    <!-- link navbar -->
    <link href="assets/css/home-seach7.css" rel="stylesheet">
        ...
        <div class="container">
            <div class="box-roon-box">
                <div class="text-h-roon">
                    ...
                    &nbsp;
                    <button class="button button5">
                        <i class="fa fa-close"></i> 2.4 E </button>
                    <span><i class="fa-solid fa-chevron-right"></i></span>
                    &nbsp;
                    <button class="button button5">
                        <i class="fa fa-close"></i> 2019 </button>
                    <span><i class="fa-solid fa-chevron-right"></i></span>
                    &nbsp;
                    <button class="button button5">
                    ...
                    &nbsp;
                    <button class="button button5">
                        <i class="fa fa-close"></i> หมวดหมู่ย่อย 1 </button>
                    <span><i class="fa-solid fa-chevron-right"></i></span>
