    ...
    <section id="sec-home-seach">
        <div class="container">
            <div class="img-img-ban">
                <img src="assets/img/home-seach/b1.png" class="img-fluid" alt="shoe image">
            ...
            <div class="box-roon-box">
                <div class="text-h-roon">
                    <button class="button button5">
                        <i class="fa fa-close"></i> Toyota </button>
                    <span><i class="fa-solid fa-chevron-right"></i></span>
                    &nbsp;
                    <button class="button button5">
                        <i class="fa fa-close"></i> Revo </button>
                    <span><i class="fa-solid fa-chevron-right"></i></span>
                ...
                <div class="box-scoll-roon">
                    <div class="row">
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div class="col-lg-5">
                                    <!-- <img src="assets/img/home-seach/r2.png" class="img-fluid" alt="shoe image">-->
                                </div>
                                <div class="col-lg-7">
                                    <div class="text-detail-roon">
                                        <p>
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div class="col-lg-5">
                                    <!-- <img src="assets/img/home-seach/r3.png" class="img-fluid" alt="shoe image">-->
                                </div>
                                <div class="col-lg-7">
                                    <div class="text-detail-roon">
                                        <p>
                        ...
                        <div class="col-sm">
                            <div class="row">
                                <div class="col-lg-5">
                                    <!-- <img src="assets/img/home-seach/r4.png" class="img-fluid" alt="shoe image">-->
                                </div>
                                <div class="col-lg-7">
                                    <div class="text-detail-roon">
                                        <p>
