@foreach($confirminventories_pending as $confirm_pending)
<div class="box__content">
    <div class="row">
        <div class="col-8">
            ...
            <p class="txt__date">วันที่สอบถาม 
                <!-- 15/12/2564 -->
                {{ date('d/m/Y', strtotime($confirm_pending->pending_date."+543 years")) }}
            </p>
        </div>
        <div class="col-4">
            @php 
                $box_status_class = "";
                switch($confirm_pending->status){
    ...
    <div class="row">
        ...
        <div class="col-10">
            <p class="txt__name">{{ $confirm_pending->product_name }}</p>
                ...
                <div class="row">
                    <div class="col-lg-8">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                @if($confirm_pending->request_vdo == 'yes')
    ...
    <div class="row">
        ...
        <div class="col-6">
            ...
            <p class="txt__problem">
                ยอดคำสั่งซื้อทั้งหมด: &nbsp;<span class="txt__price"> ฿ {{ number_format($confirm_pending->product_price,2) }} </span>
            </p>
