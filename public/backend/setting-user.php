                                    ...
                                    <?php for ($x = 1; $x <= 6; $x++) { ?>
                                        <div class="tab-pane fade <?php if ($x == 1) {
                                            ...
                                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                                ...
                                                <?php if ($x == 6) { ?>
                                                    <li class="btn__addmember" role="presentation">
                                                        <button class="nav-link" class="btn btn__addpermission" type="button" data-bs-toggle="modal" data-bs-target="#myModal1"> <img src="assets/img/setting/icon-role-active.svg" class="img-fluid" alt=""> เพิ่มสมาชิก</button>
                                                    </li>
                                                <?php } ?>
                                            </ul>
